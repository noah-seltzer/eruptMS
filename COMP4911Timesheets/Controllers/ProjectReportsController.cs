...
namespace COMP4911Timesheets.Controllers
{
    public class ProjectReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProjectReportId,StartingPercentage,CompletedPercentage,CostStarted,CostFinished,CreatedTime,Status,ProjectId")] ProjectReport projectReport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProjectReportId,StartingPercentage,CompletedPercentage,CostStarted,CostFinished,CreatedTime,Status,ProjectId")] ProjectReport projectReport)
        {
