  ...
  stages {
    stage('set properties') {
      steps {
        ...
        sh 'sudo sed -i "s/CONNECTION_STRING/"DefaultConnection": "Server=localhost,1433;Database=erupt$containerName;User ID=SA;Password=$dbpassword;"/g" $WORKSPACE/COMP4911Timesheets/appSettings.json'
