  ...
  stages {
    stage('Set Properties') {
      steps {
        ...
        sh 'sudo sed -i "s/CONNECTION_STRING/\\"DefaultConnection\\": \\"Server=localhost,1433;Database=$containerName;User ID=SA;Password=$dbpassword;\\"/g" ./COMP4911Timesheets/appsettings.json'
