  ...
  stages {
    stage('set properties') {
      steps {
        ...
        sh 'sudo sed -i "s/"DefaultConnection": "*"/"DefaultConnection": "Server=localhost,1433;Database=erupt$containerName;User ID=SA;Password=Password!123;/g" $WORKSPACE/appSettings.json'
